        ...
        >
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-4 gap-1 h-6">
              <div className={`rounded ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`} />
              <div className={`rounded ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'}`} />
              <div className={`rounded ${theme === 'dark' ? 'bg-blue-600' : 'bg-blue-500'}`} />
              <div className={`rounded ${theme === 'dark' ? 'bg-orange-600' : 'bg-orange-500'}`} />
            </div>
          </div>
