...
export function SocialProof({
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-1 text-sm text-gray-600">
          ...
          <span>{SOCIAL_PROOF_DATA.fortunesGenerated.toLocaleString()}+ generated</span>
        </div>
      </div>
    );
  }
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12">
          <Stat
            ...
            value={`${SOCIAL_PROOF_DATA.fortunesGenerated.toLocaleString()}+`}
            label="Fortunes Generated"
          />
          <Stat
            icon={<Users className="h-5 w-5" />}
            value={`${SOCIAL_PROOF_DATA.happyUsers.toLocaleString()}+`}
            label="Happy Users"
          />
          <Stat
  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:block h-6 w-px bg-amber-200" aria-hidden="true" />

      <div className="flex items-center gap-2 text-gray-600">
        <Cookie className="h-4 w-4 text-amber-500" aria-hidden="true" />
        <span className="text-sm font-medium">
          {SOCIAL_PROOF_DATA.fortunesGenerated.toLocaleString()}+ fortunes generated
        </span>
      </div>
    </div>
  );
...
// Internal stat component for hero variant
function Stat({
  icon,
  value,
  label,
