...
export const recipeFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Fortune cookies are typically baked at 300°F (150°C) for 12-15 minutes until the edges are lightly golden. This temperature ensures they cook evenly without burning."
  },
  {
    question: "Can I make gluten-free fortune cookies?",
    answer: "Yes! You can substitute all-purpose flour with a gluten-free flour blend. The texture may be slightly different, but they'll still fold and taste great."
  }
]
...
export const howToMakeFAQs: FAQItem[] = [
  {
    ...
    answer: "Making fortune cookies at home is moderately challenging. The baking is easy, but you need to work quickly to fold them while they're still warm and pliable."
  },
  {
    question: "What's the most important tip for making fortune cookies?",
    answer: "Work fast! Fortune cookies must be shaped while they're still hot from the oven. Once they cool, they become brittle and will crack if you try to fold them."
  },
  {
    question: "How do I prevent fortune cookies from sticking to the pan?",
    answer: "Always use parchment paper or silicone baking mats. Never use cooking spray or butter directly on the pan as it can affect the cookie's texture."
  },
  {
    question: "Can I prepare the batter ahead of time?",
    answer: "It's best to use the batter immediately after mixing. The batter can separate if left sitting, which affects the cookie's texture and ability to fold properly."
  },
  {
    question: "What size should I make the fortune cookie circles?",
    answer: "Make circles about 3-4 inches in diameter. This size is perfect for folding and creates the classic fortune cookie shape without being too thick or thin."
  }
]
...
export const whoInventedFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Tsujiura senbei are traditional Japanese crackers that contained fortunes or predictions. They're considered the predecessor to modern fortune cookies and were popular in Japan during the 19th century."
  }
]
...
export const historyFAQs: FAQItem[] = [
  {
    ...
    answer: "Fortune cookies have a complex history spanning from 19th century Japan to early 20th century California. They evolved from Japanese tsujiura senbei and were popularized in American Chinese restaurants."
  },
  {
    question: "When did fortune cookies become popular in America?",
    answer: "Fortune cookies gained popularity in America during the 1940s and 1950s when Chinese restaurants began serving them as complimentary desserts. They became a staple of American Chinese cuisine by the 1960s."
  },
  {
    question: "Are fortune cookies eaten in China?",
    answer: "No, fortune cookies are not traditionally eaten in China and are largely unknown there. They're considered an American invention and are primarily found in Chinese restaurants outside of China."
  },
  {
    question: "How did fortune cookies spread across America?",
    answer: "Fortune cookies spread through Chinese restaurants across America after World War II. Restaurant owners found them to be an inexpensive and memorable way to end meals, leading to widespread adoption."
  },
  {
    question: "What was the original purpose of fortune cookies?",
    answer: "Originally, fortune cookies served as a gesture of hospitality and entertainment. They provided diners with a small surprise and positive message to end their meal on a pleasant note."
  }
]
