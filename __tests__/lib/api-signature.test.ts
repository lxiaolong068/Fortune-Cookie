...
describe('API Signature', () => {
  ...
  describe('ApiKeyManager', () => {
    ...
    it('checks permissions correctly', () => {
      ...
      expect(ApiKeyManager.hasPermission(testKeyId, 'any-permission')).toBe(true)
  ...
  describe('ClientSigner', () => {
    it('generates complete signature headers', () => {
      ...
      const timestamp = parseInt(headers[SIGNATURE_HEADERS.TIMESTAMP])
      const isValid = RequestSigner.verifySignature(
        testSecret,
        ...
        testBody,
        timestamp,
        headers[SIGNATURE_HEADERS.NONCE]
      )
