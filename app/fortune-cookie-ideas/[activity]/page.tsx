...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `${baseUrl}/api/og?type=pseo&title=${encodeURIComponent(data.title)}&emoji=${encodeURIComponent(data.emoji)}&badge=${encodeURIComponent(data.badge)}&description=${encodeURIComponent(data.description.slice(0, 120))}&gradient=green`,
          width: 1200,
          height: 630,
          alt: data.title,
        },
    ...
    twitter: {
      ...
      title: data.metaTitle,
      description: data.metaDescription,
      images: [`${baseUrl}/api/og?type=pseo&title=${encodeURIComponent(data.title)}&emoji=${encodeURIComponent(data.emoji)}&badge=${encodeURIComponent(data.badge)}&description=${encodeURIComponent(data.description.slice(0, 120))}&gradient=green`],
