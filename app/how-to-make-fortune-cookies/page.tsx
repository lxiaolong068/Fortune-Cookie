...
const steps = [
  {
    ...
    description:
      "Preheat oven to 300°F (150°C). Line baking sheets with parchment paper. Prepare your fortune messages by cutting them into strips about 3 inches long and 1/2 inch wide.",
    time: "5 minutes",
    tips: [
      "Have all ingredients at room temperature",
      "Prepare fortunes before you start baking",
    ],
  },
  {
    step: 2,
    ...
    description:
      "In a large bowl, whisk egg whites and sugar until frothy (about 2 minutes). Add melted butter, vanilla, and almond extracts. Mix well until combined.",
    time: "5 minutes",
    tips: [
      "Don't overbeat the egg whites",
      "Make sure butter is cooled slightly before adding",
    ],
  },
  {
    step: 3,
    ...
    description:
      "Gradually add flour, water, and salt to the mixture. Stir until you have a smooth batter with no lumps. The consistency should be similar to thin pancake batter.",
    time: "3 minutes",
    tips: [
      "Sift flour for smoother batter",
  ...
  },
  {
    ...
    description:
      "Drop 1 tablespoon of batter onto prepared baking sheets, spacing them 4 inches apart. Use the back of a spoon to spread into 4-inch circles. Bake for 15-20 minutes until edges are golden brown.",
    time: "15-20 minutes",
    tips: [
      "Only bake 2-3 cookies at a time",
      "Cookies should be golden but not brown",
    ],
  },
  {
    step: 5,
    ...
    description:
      "Remove from oven and work quickly while cookies are hot. Place fortune in center, fold cookie in half, then bend over the edge of a bowl or muffin tin to create the classic shape.",
    time: "30 seconds per cookie",
    tips: [
      "Work with one cookie at a time",
      "Use oven mitts to protect your hands",
      "If cookie hardens, return to oven for 30 seconds",
    ],
  },
  {
    step: 6,
    ...
    description:
      "Place shaped cookies in muffin tin cups to maintain their shape while cooling. Once completely cool, store in airtight containers for up to one week.",
    time: "10 minutes",
    tips: [
...
const troubleshooting = [
  {
    ...
    solution:
      "Spread the batter thinner on the baking sheet. Use less batter per cookie.",
  },
  {
    problem: "Cookies crack when folding",
    solution:
      "Work faster while cookies are hot, or return to oven for 30 seconds to soften.",
  },
  {
  ...
  },
  {
    ...
    solution:
      "Add water 1 teaspoon at a time until you reach the right consistency.",
  },
];
    ...
    <>
      ...
      <BreadcrumbStructuredData
        items={[
          ...
          {
            name: "How to Make Fortune Cookies",
            url: "/how-to-make-fortune-cookies",
          },
        ]}
      />
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-6">
                Learn to make delicious homemade fortune cookies with this easy
                step-by-step guide. Perfect for beginners and guaranteed to
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      The key to successful fortune cookies is working quickly
                      while they’re hot. Have your fortunes ready and work with
                      only 2-3 cookies at a time.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-3">
                    ...
                    <p className="text-gray-600 mb-4">
                      Keep your oven at exactly 300°F. Too hot and the cookies
                      will brown too quickly; too cool and they won’t set
                      properly.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Don’t worry if your first few cookies aren’t perfect. The
                      shaping technique takes practice, but even imperfect
                      cookies taste great!
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Make your fortune cookies extra special by writing
                      personalized messages. Keep them short, positive, and
                      meaningful to your recipients.
                    </p>
                  </div>
                </div>
              </Card>
