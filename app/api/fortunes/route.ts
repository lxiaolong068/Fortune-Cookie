    ...
    switch (action) {
      case "search": {
        ...
        const category = searchParams.get("category")
          ? sanitizeString(searchParams.get("category")!, 50)
          : undefined;
        ...
        if (cachedResults) {
          ...
          const responseData = EdgeCacheManager.optimizeApiResponse(
            cachedResults,
            cacheKey,
            300,
          );
      ...
      case "list":
      default: {
        const page = validatePositiveInteger(
